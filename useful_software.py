    ...
    while True:
        ...
        if usefulsoftware_choice == '1':
            ...
            print("Nvidia App > Graphics > Global Settings:\n"
                  ...
                  "        - Ex. 144hz = 139, 240hz = 226, etc...\n"
                  "        - Src : https://www.reddit.com/r/nvidia/comments/1lokih2/putting_misconceptions_about_optimal_fps_caps/\n"
                  ...
                  "    - Vertical Sync : On (make sure V-Sync is OFF in-game)\n"
